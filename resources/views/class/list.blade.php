      ...
      <!-- Content wrapper -->
        <div class="content-wrapper">
            ...
            <div class="container-xxl flex-grow-1 container-p-y">    
                  <h4 class="py-3 mb-4">
                    <span class="text-muted fw-light">Class /</span> Registered
                  </h4>
                  <!-- Fixed Header -->
                  <div class="card">
                    <h5 class="card-header">List of Class</h5>
                      ...
                      <table class="table table-striped table-bordered" id="student_list">
                        ...
                        <tbody class="table-border-bottom-0">
                          ...
                          <tr> 
                            ...
                            <td>{{ ($class->NumberOfSubjects) }}</td>
                            <td>{{ ($class->AddedId) }}</td>
                            <td>{{ ($class->Role) }}</td>
                            <td>{{ \Carbon\Carbon::parse($class->DateAdded)->format('d-m-Y') }}</td>
                            <td>
